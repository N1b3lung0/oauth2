...
public class Oauth2SpringSecurityTests {
    ...
    void shouldRequireValidTokens() throws Exception {
        String token = mint();
        this.mvc.perform(get("/exercises/100")
    ...
    void shouldShowAllTokenValidationErrors() throws Exception {
        ...
        this.mvc.perform(get("/exercises").header("Authorization", "Bearer " + expired))
                .andExpect(status().isUnauthorized())
    ...
    private String mint(Consumer<JwtClaimsSet.Builder> consumer) {
        JwtClaimsSet.Builder builder = JwtClaimsSet.builder()
                ...
                .audience(Arrays.asList("exercise-client"))
                .claim("scp", Arrays.asList("exercise:read", "exercise:write"));
